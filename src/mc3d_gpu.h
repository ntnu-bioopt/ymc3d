...
void run_3dmc_gpu(Geometry geometry, OpticalProps optProps, int num_photons, double *R, double *R_tot, double *T, double *T_tot, float *A, int *num_finished_photons);
